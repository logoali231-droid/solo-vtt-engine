...
export const SPELLS: SpellDef[] = [
  ...
  { id: "acid-splash", name: "Acid Splash", level: 0, school: "Conjuration", range: "60 ft", cast: "1 action", save: "dex", damage: "1d6", description: "A glob of acid; targets in a 5-ft square must save.", classes: ["artificer", "sorcerer", "wizard"] },
  { id: "shocking-grasp", name: "Shocking Grasp", level: 0, school: "Evocation", range: "Touch", cast: "1 action", attack: true, damage: "1d8", description: "Lightning crackles from your hand; the target can't take reactions.", classes: ["artificer", "sorcerer", "wizard"] },
  { id: "poison-spray", name: "Poison Spray", level: 0, school: "Conjuration", range: "10 ft", cast: "1 action", save: "con", damage: "1d12", description: "A puff of toxic gas; cover grants no benefit.", classes: ["artificer", "druid", "sorcerer", "warlock", "wizard"] },
  ...
  { id: "inflict-wounds", name: "Inflict Wounds", level: 1, school: "Necromancy", range: "Touch", cast: "1 action", attack: true, damage: "3d10", description: "A touch of necrotic energy — a devastating hit when it lands.", classes: ["cleric"] },
  { id: "witch-bolt", name: "Witch Bolt", level: 1, school: "Evocation", range: "30 ft", cast: "1 action", concentration: true, attack: true, damage: "1d12", description: "A crackling arc of lightning; repeat the damage while you hold it.", classes: ["sorcerer", "warlock", "wizard"] },
  { id: "ray-of-sickness", name: "Ray of Sickness", level: 1, school: "Necromancy", range: "60 ft", cast: "1 action", attack: true, damage: "2d8", description: "A sickly green ray; the target may be poisoned on a hit.", classes: ["sorcerer", "wizard"] },
  ...
  { id: "acid-arrow", name: "Melf's Acid Arrow", level: 2, school: "Evocation", range: "90 ft", cast: "1 action", attack: true, damage: "4d4", description: "A shimmering arrow of acid; the damage continues next turn.", classes: ["wizard"] },
...
export const KNOWN_SPELLS_BY_CLASS: Partial<Record<DnDClassId, string[]>> = {
  artificer: ["fire-bolt", "acid-splash", "shocking-grasp", "poison-spray", "guidance", "mage-hand", "prestidigitation", "thorn-whip", "cure-wounds", "faerie-fire", "shield", "magic-missile", "shatter", "flaming-sphere", "web", "dispel-magic", "fly", "haste", "revivify"],
  ...
  cleric: ["guidance", "sacred-flame", "word-of-radiance", "cure-wounds", "healing-word", "guiding-bolt", "bless", "inflict-wounds", "spiritual-weapon", "hold-person", "spirit-guardians", "revivify", "dispel-magic"],
  druid: ["guidance", "thorn-whip", "poison-spray", "produce-flame", "cure-wounds", "healing-word", "faerie-fire", "thunderwave", "moonbeam", "flaming-sphere", "pass-without-trace", "sleet-storm", "conjure-animals", "dispel-magic"],
  paladin: ["cure-wounds", "bless", "dispel-magic", "revivify"],
  ranger: ["cure-wounds", "pass-without-trace", "conjure-animals"],
  sorcerer: ["fire-bolt", "acid-splash", "shocking-grasp", "poison-spray", "ray-of-frost", "mage-hand", "prestidigitation", "chill-touch", "burning-hands", "magic-missile", "shield", "chromatic-orb", "witch-bolt", "ray-of-sickness", "thunderwave", "sleep", "scorching-ray", "shatter", "misty-step", "web", "hold-person", "suggestion", "mirror-image", "flaming-sphere", "fireball", "lightning-bolt", "counterspell", "fly", "haste", "slow", "hypnotic-pattern", "sleet-storm", "dispel-magic"],
  warlock: ["eldritch-blast", "poison-spray", "chill-touch", "mage-hand", "prestidigitation", "hellish-rebuke", "arms-of-hadar", "witch-bolt", "shatter", "misty-step", "hold-person", "suggestion", "mirror-image", "counterspell", "hypnotic-pattern", "fly", "dispel-magic"],
  wizard: ["fire-bolt", "acid-splash", "shocking-grasp", "poison-spray", "ray-of-frost", "mage-hand", "prestidigitation", "chill-touch", "burning-hands", "magic-missile", "shield", "chromatic-orb", "witch-bolt", "ray-of-sickness", "thunderwave", "sleep", "scorching-ray", "shatter", "misty-step", "web", "hold-person", "suggestion", "mirror-image", "flaming-sphere", "acid-arrow", "fireball", "lightning-bolt", "counterspell", "fly", "haste", "slow", "hypnotic-pattern", "sleet-storm", "dispel-magic"],
};
